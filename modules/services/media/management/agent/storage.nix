{
  ...
  systemd.tmpfiles.rules = [
    ...
    "d /src/appdata 0770 root media - -"
    "d /src/appdata/media-management 0770 root media - -"
    "d /src/appdata/media-management/radarr 0770 root media - -"
    "d /src/appdata/media-management/sonarr 0770 root media - -"
    "d /src/appdata/media-management/prowlarr 0770 root media - -"
    "d /src/appdata/media-management/sabnzbd 0770 root media - -"
    "d /src/appdata/media-management/bazarr 0770 root media - -"
    "d /src/appdata/media-management/recyclarr 0770 root media - -"
    "d /src/appdata/media-management/lidarr 0770 root media - -"
    "d /src/appdata/media-management/jellyseerr 0770 root media - -"
  ];
}
